...
(function() {
  ...
  // Initialize Partner Sliders
  const partnerSliders = document.querySelectorAll('.partner-slider');
  partnerSliders.forEach((slider, index) => {
    new Swiper(slider, {
      slidesPerView: 10,
      spaceBetween: 20,
      loop: true,
      autoplay: {
        ...
        reverseDirection: index === 1 // Second row slides in opposite direction
      },
      speed: 5000,
      breakpoints: {
        320: {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      // Create WhatsApp URL
      const whatsappUrl = `https://wa.me/971507668536?text=${whatsappMessage}`;
