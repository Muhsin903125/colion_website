// Modern JavaScript for Colion International Website
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const counters = document.querySelectorAll('.stat-number[data-purecounter-end]');
    
    const countUp = (counter) => {
        const target = parseInt(counter.getAttribute('data-purecounter-end'));
        const duration = parseInt(counter.getAttribute('data-purecounter-duration')) * 1000 || 2000;
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            // Open WhatsApp
            window.open(`https://wa.me/971507668536?text=${whatsappMessage}`, '_blank');
        });
    }
